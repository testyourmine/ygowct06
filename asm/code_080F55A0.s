...
_080F9D3A:
	...
	adds r1, r1, r2
	lsls r1, r1, #9
	ldr r2, _080F9E0C @ =gCardIconsLarge
	mov r8, r2
	add r1, r8
	movs r2, #0xc0
	lsls r2, r2, #3
	...
	adds r1, r1, r2
	lsls r1, r1, #7
	ldr r4, _080F9E14 @ =gCardIconsSmall
	adds r1, r1, r4
	movs r6, #0x90
	lsls r6, r6, #3
	adds r2, r6, #0
...
sub_080F9E20: @ 0x080F9E20
	...
	ldr r2, _080F9EC4 @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r3, [r1]
	ldr r0, _080F9EC8 @ =gInterfaceText
	adds r3, r3, r0
	movs r0, #1
	movs r1, #1
	movs r2, #0x87
...
_080F9EC4: .4byte gInterfaceTextOffsets
_080F9EC8: .4byte gInterfaceText
...
_080FA0C6:
	...
	ldr r1, _080FA128 @ =gCardIconPalettes
	movs r2, #0x80
	lsls r2, r2, #1
	bl MemoryCopyHalfWord
	bl sub_080F5A88
...
_080FA128: .4byte gCardIconPalettes
...
sub_080FBB60: @ 0x080FBB60
	...
	adds r0, r4, #0
	bl GetInterfaceTextIdIndex
	ldr r2, _080FBC6C @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _080FBC70 @ =gInterfaceText
	adds r1, r1, r0
	mov r0, sb
	movs r2, #0x16
	bl strncpy
...
_080FBC6C: .4byte gInterfaceTextOffsets
_080FBC70: .4byte gInterfaceText
...
_080FCF8E:
	...
	strb r0, [r2, #0x15]
	movs r6, #0
	ldr r2, _080FD0D8 @ =gInterfaceTextOffsets
	mov sl, r2
	mov sb, r3
	ldr r3, _080FD0DC @ =gInterfaceText
	mov r8, r3
	movs r7, #2
_080FD02A:
...
_080FD0D8: .4byte gInterfaceTextOffsets
_080FD0DC: .4byte gInterfaceText
...
_080FE05A:
	...
	adds r0, r0, r2
	bl GetInterfaceTextIdIndex
	ldr r2, _080FE0C8 @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _080FE0CC @ =gInterfaceText
	adds r6, r1, r0
	b _080FE0E2
	.align 2, 0
...
_080FE0C8: .4byte gInterfaceTextOffsets
_080FE0CC: .4byte gInterfaceText
_080FE0D0:
	lsls r0, r1, #7
	adds r0, r0, r1
	lsls r0, r0, #2
...
_080FE26A:
	...
	movs r4, #0xa0
	lsls r4, r4, #0x13
	ldr r1, _080FE2AC @ =gCardIconPalette0
	movs r2, #0x90
	lsls r2, r2, #1
	adds r0, r4, #0
	bl MemoryCopyHalfWord
	...
	bx r1
	.align 2, 0
_080FE2AC: .4byte gCardIconPalette0
...
_08100D7E:
	...
	bl GetInterfaceTextIdIndex
	ldr r2, _08100E14 @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _08100E18 @ =gInterfaceText
	adds r5, r1, r0
	b _08100E9E
	.align 2, 0
...
_08100E14: .4byte gInterfaceTextOffsets
_08100E18: .4byte gInterfaceText
_08100E1C:
	cmp r5, #0
	bge _08100E48
	adds r0, r6, #0
...
_08100E6A:
	bl GetInterfaceTextIdIndex
	ldr r2, _08100F20 @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _08100F2C @ =gInterfaceText
	adds r5, r1, r0
	mov r0, sp
	adds r1, r5, #0
	adds r2, r4, #0
...
_08100F20: .4byte gInterfaceTextOffsets
_08100F24: .4byte gUnk_02000000
_08100F28: .4byte 0x00006C2C
_08100F2C: .4byte gInterfaceText
...
sub_08100F38: @ 0x08100F38
	...
	adds r0, r0, r2
	bl GetInterfaceTextIdIndex
	ldr r2, _08101054 @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _08101058 @ =gInterfaceText
	adds r5, r1, r0
	adds r0, r5, #0
	bl strlen
	muls r0, r7, r0
...
_08101054: .4byte gInterfaceTextOffsets
_08101058: .4byte gInterfaceText
...
sub_081011C4: @ 0x081011C4
	...
	beq _08101294
	movs r5, #0
	ldr r3, _0810127C @ =gUnk_02000000+0x6C2C
	mov sl, r3
_081011E8:
	movs r4, #0
	lsls r6, r5, #2
...
_08101246:
	...
	adds r1, r1, r0
	lsls r1, r1, #7
	ldr r0, _08101290 @ =gCardIconsSmall
	adds r1, r1, r0
	adds r0, r3, #0
	movs r2, #0x90
	lsls r2, r2, #2
...
_08101294:
	movs r5, #0
	ldr r0, _081012F8 @ =gUnk_02000000+0x6C2C
	mov r8, r0
...
_081012D8:
	...
	adds r1, r1, r0
	lsls r1, r1, #7
	ldr r0, _08101310 @ =gCardIconsSmall
	adds r1, r1, r0
	adds r0, r3, #0
	movs r2, #0x90
	lsls r2, r2, #2
	...
	b _0810131E
	.align 2, 0
_081012F8: .4byte gUnk_02000000+0x6C2C
...
sub_08105D94: @ 0x08105D94
	...
	adds r1, r1, r0
	lsls r1, r1, #1
	ldr r2, _08105F18 @ =gUnk_02000000+0x6C2C
	ldrb r2, [r2]
	lsls r0, r2, #0x1d
	lsrs r0, r0, #0x1d
	adds r1, r1, r0
	lsls r1, r1, #2
	ldr r3, _08105F1C @ =gInterfaceTextOffsets
	adds r1, r1, r3
	ldr r1, [r1]
	ldr r0, _08105F20 @ =gInterfaceText
	adds r7, r1, r0
	...
	ldr r3, _08105F1C @ =gInterfaceTextOffsets
	mov sb, r3
	ldr r0, _08105F18 @ =gUnk_02000000+0x6C2C
	mov r8, r0
...
_08105F18: .4byte gUnk_02000000+0x6C2C
_08105F1C: .4byte gInterfaceTextOffsets
_08105F20: .4byte gInterfaceText
...
_08105FF0:
	adds r0, r5, #0
	bl GetInterfaceTextIdIndex
	ldr r1, _081060C8 @ =gInterfaceTextOffsets
	mov sb, r1
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	...
	add r1, sb
	ldr r0, [r1]
	ldr r5, _081060D4 @ =gInterfaceText
	adds r7, r0, r5
	adds r0, r7, #0
	bl strlen
	lsls r1, r0, #1
...
_081060C8: .4byte gInterfaceTextOffsets
_081060CC: .4byte gUnk_02000000
_081060D0: .4byte 0x00006C2C
_081060D4: .4byte gInterfaceText
...
_08106392:
	...
	adds r0, r0, r3
	bl GetInterfaceTextIdIndex
	ldr r2, _0810641C @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_0810641C: .4byte gInterfaceTextOffsets
_08106420:
	subs r1, r6, r0
	lsls r0, r1, #7
	adds r0, r0, r1
...
_081064BE:
	...
	bl GetInterfaceTextIdIndex
	ldr r2, _08106580 @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_08106508:
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _08106584 @ =gInterfaceText
	adds r5, r1, r0
_08106516:
	mov r0, sp
	adds r1, r5, #0
...
_08106580: .4byte gInterfaceTextOffsets
_08106584: .4byte gInterfaceText
...
_081073F4:
	...
	ldrsh r0, [r4, r5]
	bl GetInterfaceTextIdIndex
	ldr r2, _08107478 @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _08107484 @ =gInterfaceText
	adds r1, r1, r0
	mov sb, r1
_08107424:
	mov r0, sb
...
_0810742C:
	...
	b _08107494
	.align 2, 0
_08107478: .4byte gInterfaceTextOffsets
_0810747C: .4byte gUnk_02000000
_08107480: .4byte 0x00006C2C
_08107484: .4byte gInterfaceText
_08107488:
	ldr r2, [sp, #0x110]
	cmp r2, #0x18
	bne _081074A8
...
_0810763C:
	...
	add r3, sp
	mov sl, r3
	ldr r7, _08107750 @ =gInterfaceTextOffsets
	ldr r6, _08107754 @ =gUnk_02000000+0x6C2C
...
_0810765E:
	...
	adds r1, r1, r7
	ldr r1, [r1]
	ldr r0, _0810775C @ =gInterfaceText
	adds r4, r1, r0
	ldr r3, [sp, #0x128]
	str r3, [sp]
	mov r0, sl
...
_081076DC:
	...
	adds r1, r1, r0
	lsls r1, r1, #1
	ldr r4, _08107754 @ =gUnk_02000000+0x6C2C
	ldrb r4, [r4]
	lsls r0, r4, #0x1d
	lsrs r0, r0, #0x1d
	adds r1, r1, r0
	lsls r1, r1, #2
	ldr r5, _08107750 @ =gInterfaceTextOffsets
	adds r1, r1, r5
	ldr r1, [r1]
	ldr r0, _0810775C @ =gInterfaceText
	adds r4, r1, r0
...
_08107750: .4byte gInterfaceTextOffsets
_08107754: .4byte gUnk_02000000+0x6C2C
_08107758: .4byte gUnk_09E606E0
_0810775C: .4byte gInterfaceText
_08107760:
	movs r6, #0
	movs r0, #0x84
	lsls r0, r0, #1
	...
	add r1, sp
	mov sl, r1
	ldr r4, _08107788 @ =gUnk_02000000+0x6C2C
_08107774:
	movs r0, #7
	ldrb r2, [r4]
	ands r0, r2
	...
	b _08107794
	.align 2, 0
_08107788: .4byte gUnk_02000000+0x6C2C
_0810778C:
	add r0, sp, #8
	adds r1, r6, #0
	bl sub_0810A0E8
...
_08109B28:
	...
	blt _08109BB8
	bl GetInterfaceTextIdIndex
	ldr r2, _08109BA8 @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _08109BB4 @ =gInterfaceText
	adds r1, r1, r0
	str r1, [sp]
	b _08109BBC
	.align 2, 0
...
_08109BA8: .4byte gInterfaceTextOffsets
_08109BAC: .4byte gUnk_02000000
_08109BB0: .4byte 0x00006C2C
_08109BB4: .4byte gInterfaceText
_08109BB8:
	movs r4, #0
	str r4, [sp]
_08109BBC:
...
_08109E8A:
	...
	ldrsh r0, [r1, r2]
	bl GetInterfaceTextIdIndex
	ldr r2, _08109EDC @ =gInterfaceTextOffsets
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
	...
	adds r1, r1, r2
	ldr r1, [r1]
	ldr r0, _08109EE8 @ =gInterfaceText
	adds r4, r1, r0
	b _08109EEE
	.align 2, 0
_08109EDC: .4byte gInterfaceTextOffsets
_08109EE0: .4byte gUnk_02000000
_08109EE4: .4byte 0x00006C2C
_08109EE8: .4byte gInterfaceText
_08109EEC:
	movs r4, #0
_08109EEE:
	cmp r4, #0
