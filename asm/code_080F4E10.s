...
@ 	thumb_func_start sub_080F4E10
@ sub_080F4E10: @ 0x080F4E10
@ 	bx lr
@ 	.align 2, 0

@ 	thumb_func_start sub_080F4E14
@ sub_080F4E14: @ 0x080F4E14
@ 	bx lr
@ 	.align 2, 0
...
@ 	adds r5, r0, #0
@ 	movs r4, #0
@ 	ldr r0, _080F4E40 @ =gUnk_08000240
@ 	ldrh r3, [r0]
@ 	subs r3, #1
@ 	ldr r6, _080F4E44 @ =gUnk_08000250
@ _080F4E26:
@ 	adds r0, r4, r3
@ 	lsrs r1, r0, #0x1f
@ 	adds r0, r0, r1
...
@ 	b _080F4E6C
@ 	.align 2, 0
@ _080F4E40: .4byte gUnk_08000240
@ _080F4E44: .4byte gUnk_08000250
@ _080F4E48:
@ 	cmp r4, r3
@ 	bne _080F4E50
@ 	movs r0, #0
...
@ 	cmp r0, #0
@ 	beq _080F521E
@ 	ldr r6, _080F520C @ =gUnk_02000000+0x6C2C
@ _080F51BC:
@ 	cmp r0, #0x25
@ 	bne _080F5210
@ 	ldrb r0, [r4, #1]
...
@ 	b _080F5222
@ 	.align 2, 0
@ _080F520C: .4byte gUnk_02000000+0x6C2C
@ _080F5210:
@ 	ldrb r0, [r4]
@ 	strb r0, [r5]
@ 	adds r4, #1
...
@ 	cmp r0, #0
@ 	beq _080F5280
@ 	ldr r1, _080F525C @ =gUnk_02000000+0x6C2C
@ _080F5236:
@ 	cmp r0, #0x25
@ 	bne _080F5272
@ 	ldrb r0, [r4, #1]
...
@ 	b _080F5268
@ 	.align 2, 0
@ _080F525C: .4byte gUnk_02000000+0x6C2C
@ _080F5260:
@ 	adds r0, r5, #0
@ 	adds r1, r2, #0
@ 	bl sub_080F50F0
...
sub_080F9E20: @ 0x080F9E20
	...
	adds r0, r0, r1
	bl sub_080F4E18
	ldr r2, _080F9EC4 @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
sub_080FBB60: @ 0x080FBB60
	...
	adds r0, r4, #0
	bl sub_080F4E18
	ldr r2, _080FBC6C @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_080FCF8E:
	...
	strb r0, [r2, #0x15]
	movs r6, #0
	ldr r2, _080FD0D8 @ =gUnk_08000F40
	mov sl, r2
	mov sb, r3
...
_080FE05A:
	...
	adds r0, r0, r2
	bl sub_080F4E18
	ldr r2, _080FE0C8 @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_08100D7E:
	...
	bl sub_080F4E18
	ldr r2, _08100E14 @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_08100E6A:
	bl sub_080F4E18
	ldr r2, _08100F20 @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
sub_08100F38: @ 0x08100F38
	...
	adds r0, r0, r2
	bl sub_080F4E18
	ldr r2, _08101054 @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
sub_08105D94: @ 0x08105D94
	...
	adds r1, r1, r0
	lsls r1, r1, #2
	ldr r3, _08105F1C @ =gUnk_08000F40
	adds r1, r1, r3
	ldr r1, [r1]
...
_08105FF0:
	adds r0, r5, #0
	bl sub_080F4E18
	ldr r1, _081060C8 @ =gUnk_08000F40
	mov sb, r1
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
...
_08106392:
	...
	adds r0, r0, r3
	bl sub_080F4E18
	ldr r2, _0810641C @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_081064BE:
	...
	bl sub_080F4E18
	ldr r2, _08106580 @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_081073F4:
	...
	ldrsh r0, [r4, r5]
	bl sub_080F4E18
	ldr r2, _08107478 @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_0810763C:
	...
	add r3, sp
	mov sl, r3
	ldr r7, _08107750 @ =gUnk_08000F40
...
_081076DC:
	...
	adds r1, r1, r0
	lsls r1, r1, #2
	ldr r5, _08107750 @ =gUnk_08000F40
	adds r1, r1, r5
	ldr r1, [r1]
	ldr r0, _0810775C @ =gUnk_09DB9C10
	adds r4, r1, r0
...
_08109B28:
	...
	blt _08109BB8
	bl sub_080F4E18
	ldr r2, _08109BA8 @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
...
_08109E8A:
	...
	ldrsh r0, [r1, r2]
	bl sub_080F4E18
	ldr r2, _08109EDC @ =gUnk_08000F40
	lsls r0, r0, #0x10
	lsrs r0, r0, #0x10
	lsls r1, r0, #1
	adds r1, r1, r0
