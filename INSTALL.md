First, you must put a Yu-Gi-Oh! Ultimate Masters: World Championship Tournament 2006 (USA) ROM (with SHA1: `9689337d6aac1ce9699ab60aac73fc2cfdccad9b`) in the root directory of the repository and name it `baserom.gba`. 
...
To set up the repository:
	...
	git clone https://github.com/jiangzhengwenjz/ygowct06
	git clone https://github.com/pret/agbcc

	cd ./agbcc
	sh build.sh interwork
	sh install.sh ../ygowct06

	cd ../ygowct06

To build **ygowct06.gba**:
